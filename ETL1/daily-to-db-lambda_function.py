# Vuelca en la BD los archivos preexistentes en el bucket de descargas diarias, invocando la lambda mediante un script 
# de python en local. Esto solo se hace una vez.
