# Transforma y vuelca en la base de datos todos los archivos JSON que se cargan en el data-lake 
...
def is_valid_title(title):
    ...
    # Revisa la validez de los titulos antes de insertar en la base de datos.
